...
<template>
  ...
  <div class="main-wrapper">
          ...
          <ul class="list-group list-group-flush">
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-8.png" alt="image" class="w35">
              </figure>
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-6.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-5.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-4.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
                <a class="font-xssss text-grey-600 d-block text-dark model-popup-chat" href="#">Hurin Seary</a>
              </h3>
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-3.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-2.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
            ...
            <li class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
              <figure class="avatar float-left mb-0 me-2">
                <img src="/tpl1/images/user-12.png" alt="image" class="w35">
              </figure>
              <h3 class="fw-700 mb-0 mt-0">
    ...
    <div class="app-footer border-0 shadow-lg bg-primary-gradiant">
      ...
      <a href="default-settings.html" class="nav-content-bttn"><img src="/tpl1/images/female-profile.png" alt="user" class="w30 shadow-xss"></a>
    </div>
        ...
        <div class="modal-body p-0">
          <div class="card w-100 border-0 rounded-3 overflow-hidden bg-gradiant-bottom bg-gradiant-top">
            <div class="owl-carousel owl-theme dot-style3 story-slider owl-dot-nav nav-none">
              <div class="item"><img src="/tpl1/images/story-5.jpg" alt="image"></div>
              <div class="item"><img src="/tpl1/images/story-6.jpg" alt="image"></div>
              <div class="item"><img src="/tpl1/images/story-7.jpg" alt="image"></div>
              <div class="item"><img src="/tpl1/images/story-8.jpg" alt="image"></div>
      ...
      <div class="modal-popup-header w-100 border-bottom">
        <div class="card p-3 d-block border-0 d-block">
          <figure class="avatar mb-0 float-left me-2">
            <img src="/tpl1/images/user-12.png" alt="image" class="w35 me-1">
          </figure>
