      ...
      <div class="nav-content">
        <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
          ...
          <ul class="mb-1 top-content">
            ...
            <li class="active"><NuxtLink to="/veganlog/create" class="nav-content-bttn open-font"><i class="fa-solid fa-rectangle-list btn-round-md bg-blue-gradiant me-3"></i><span>Vegan Log</span></NuxtLink></li>
