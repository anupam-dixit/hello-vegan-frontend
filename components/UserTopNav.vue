...
<template>
  ...
  <div class="nav-header bg-white shadow-xs border-0">
    <div class="nav-top">
      <NuxtLink to="/"><i class="feather-zap text-success display1-size me-2 ms-0"></i><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">{{env.APP.NAME}} </span> </NuxtLink>
    ...
    <div class="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg" aria-labelledby="dropdownMenu3">
      ...
      <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
        <img src="/tpl1/images/user-8.png" alt="user" class="w40 position-absolute left-0">
      ...
      <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
        <img src="/tpl1/images/user-4.png" alt="user" class="w40 position-absolute left-0">
      ...
      <div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
        <img src="/tpl1/images/user-7.png" alt="user" class="w40 position-absolute left-0">
      ...
      <div class="card bg-transparent-card w-100 border-0 ps-5">
        <img src="/tpl1/images/user-6.png" alt="user" class="w40 position-absolute left-0">
    ...
    <a href="default-settings.html" class="p-0 ms-3 menu-icon"><img src="/tpl1/images/profile-4.png" alt="user" class="w40 mt--1"></a>
