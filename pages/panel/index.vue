...
<template>
  <PanelHeader title="Dashboard" description="Admin Panel" icon="chart-line"></PanelHeader>
        ...
        <a class="card lift h-100" href="#!">
          <div class="card-body d-flex justify-content-center flex-column">
            <div class="d-flex align-items-center justify-content-between">
              <div class="me-3">
                <i class="fa-2x text-primary mb-3 fa-solid fa-lg fa-box"></i>
                <h5>Powerful Components</h5>
                <div class="text-muted small">To create informative visual elements on your pages</div>
              </div>
              <img src="/panel/images/browser-stats.svg" alt="..." style="width: 8rem">
            </div>
          </div>
        </a>
      </div>
      <div class="col-xl-4 mb-4">
        ...
        <a class="card lift h-100" href="#!">
          <div class="card-body d-flex justify-content-center flex-column">
            <div class="d-flex align-items-center justify-content-between">
              <div class="me-3">
                <i class="text-secondary mb-3 fa-2x fa-solid fa-lg fa-book"></i>
                <h5>Documentation</h5>
                <div class="text-muted small">To keep you on track when working with our toolkit</div>
              </div>
              <img src="/panel/images/processing.svg" alt="..." style="width: 8rem">
            </div>
          </div>
        </a>
      </div>
              ...
              <div class="tab-pane fade" id="activities" role="tabpanel" aria-labelledby="activities-pill">
                <table id="datatablesSimple">
                  ...
                  <tr>
                    <td>01/13/20</td>
                    <td>
                      <i class="me-2 text-green fa-solid fa-lg fa-plug-circle-check"></i>
                      Server online
                    </td>
                    <td>1:21 AM</td>
                  </tr>
                  <tr>
                    <td>01/13/20</td>
                    <td>
                      <i class="me-2 text-red fa-solid fa-lg fa-plug-circle-xmark"></i>
                      Server restarted
                    </td>
                    <td>1:00 AM</td>
                  </tr>
                  <tr>
                    <td>01/12/20</td>
                    <td>
                      <i class="me-2 text-purple fa-solid fa-lg fa-cart-shopping"></i>
                  ...
                  <tr>
                    <td>01/12/20</td>
                    <td>
                      <i class="me-2 text-blue fa-solid fa-lg fa-user"></i>
                  ...
                  <tr>
                    <td>01/12/20</td>
                    <td>
                      <i class="me-2 text-yellow fa-solid fa-lg fa-database"></i>
                  ...
                  <tr>
                    <td>01/11/20</td>
                    <td>
                      <i class="me-2 text-blue fa-solid fa-lg fa-user-plus"></i>
                      New user created:
                      <a href="#!">Sam Malone</a>
                    </td>
                    <td>4:18 PM</td>
                  ...
                  <tr>
                    <td>01/11/20</td>
                    <td>
                      <i class="me-2 text-green fa-solid fa-lg fa-bolt"></i>
                      Server online
                    </td>
                    <td>1:19 AM</td>
                  </tr>
                  <tr>
                    <td>01/11/20</td>
                    <td>
                      <i class="me-2 text-red fa-solid fa-lg fa-plug-circle-exclamation"></i>
                      Server restarted
                    </td>
                    <td>1:00 AM</td>
                  </tr>
        ...
        <div class="card mb-4">
          <div class="card-body py-5">
            <div class="d-flex flex-column justify-content-center">
              <img class="img-fluid mb-4" src="/panel/images/data-report.svg" alt="" style="height: 10rem">
            ...
            <div class="card card-header-actions h-100">
              <div class="card-header">
                ...
                <div class="dropdown no-caret">
                  <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownMenuButton" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical text-gray-500"></i></button>
      ...
      <div class="col-xxl-4">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-1.png" alt=""></div>
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople1" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-2.png" alt=""></div>
                    <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople2" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-3.png" alt=""></div>
                    <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople3" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-4.png" alt=""></div>
                    <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople4" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-5.png" alt=""></div>
                    <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople5" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center flex-shrink-0 me-3">
                    <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="/panel/images/profile-6.png" alt=""></div>
                    <div class="d-flex flex-column fw-bold">
                  ...
                  <div class="dropdown no-caret">
                    <button class="btn btn-transparent-dark btn-icon dropdown-toggle" id="dropdownPeople6" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa-solid fa-lg fa-ellipsis-vertical"></i></button>
        ...
        <div class="card">
          <div class="card-body text-center p-5">
            <img class="img-fluid mb-4" src="/panel/images/team-spirit.svg" alt="" style="max-width: 16.25rem">
            <h5>Team Access</h5>
